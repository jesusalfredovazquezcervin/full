...
class CapturesControllerTest < ActionController::TestCase
  ...
  test "should create capture" do
    assert_difference('Capture.count') do
      post :create, capture: { fecha: @capture.fecha, fecha: @capture.fecha, hora: @capture.hora, para: @capture.para, ticket: @capture.ticket }
    end
  ...
  test "should update capture" do
    patch :update, id: @capture, capture: { fecha: @capture.fecha, fecha: @capture.fecha, hora: @capture.hora, para: @capture.para, ticket: @capture.ticket }
    assert_redirected_to capture_path(assigns(:capture))
  end
