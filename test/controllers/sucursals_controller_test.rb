...
class SucursalsControllerTest < ActionController::TestCase
  ...
  test "should create sucursal" do
    assert_difference('Sucursal.count') do
      post :create, sucursal: { cliente_id: @sucursal.cliente_id, contacto_id: @sucursal.contacto_id, nombre: @sucursal.nombre, telefono: @sucursal.telefono }
    end
  ...
  test "should update sucursal" do
    patch :update, id: @sucursal, sucursal: { cliente_id: @sucursal.cliente_id, contacto_id: @sucursal.contacto_id, nombre: @sucursal.nombre, telefono: @sucursal.telefono }
    assert_redirected_to sucursal_path(assigns(:sucursal))
  end
