...
m.every 1.day, :first_at => Time.new(2016, 12, 27, 7)  do # 7am horas
...
v.every 1.day, :first_at => Time.new(2016, 12, 27, 15)  do # 3 pm#
...
n.every 1.day, :first_at => Time.new(2016, 12, 26, 22)  do # 10 pm
