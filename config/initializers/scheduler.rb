...
m.every "1d", :first_at => Time.new(2019, 8, 15, 7)  do # 7am horas
...
v.every "1d", :first_at => Time.new(2019, 8, 15, 15)  do # 3 pm#
...
n.every "1d", :first_at => Time.new(2019, 08, 15, 22)  do # 10 pm
