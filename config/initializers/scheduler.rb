...
m.every 1.day, :first_at => Time.new(2016, 10, 7, 11)  do # 7am horas
...
v.every 1.day, :first_at => Time.new(2016, 10, 7, 15)  do # 10 pm#
...
n.every 1.day, :first_at => Time.new(2016, 10, 7, 22)  do # 10 pm
