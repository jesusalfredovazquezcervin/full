...
m.every 1.day, :first_at => Time.new(2017, 5, 11, 7)  do # 7am horas
...
v.every 1.day, :first_at => Time.new(2017, 5, 10, 15)  do # 3 pm#
...
n.every 1.day, :first_at => Time.new(2017, 5, 10, 22)  do # 10 pm
